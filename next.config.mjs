...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/category/visa-news/f1-opt', destination: '/students/student-visas', permanent: true },
      { source: '/category/visa-news/green-card', destination: '/green-card', permanent: true },
      { source: '/category/visa-news/uscis-updates', destination: '/uscis', permanent: true },
      ...
      { source: '/category/visa-bulletin/latest', destination: '/green-card/visa-bulletin', permanent: true },
      ...
      { source: '/category/tools/lottery-tracker', destination: '/', permanent: true },
      ...
      // ─── Task 4: Fix orphan location/section URLs ───
      { source: '/maryland/wicomico', destination: '/insights', permanent: true },
      { source: '/minnesota', destination: '/insights', permanent: true },
      { source: '/live-updates/canada-stem-pathway', destination: '/', permanent: true },
